...
__( '"CURE" is a WordPress theme for medical institutions. You can create a website smoothly, because page templates for running a hospital will help you. And enriching the FAQ page make users feel so safe.', 'tcd-cure' );
...
function message_featured_image_meta_box($content, $post_id, $thumbnail_id) {
  ...
  if ( $post->post_type == 'page') {
    $content .= '<p>' . __('Recommend image size. Width:500px, Height:500px.<br>This image will be used in OGP tag.', 'tcd-w') . '</p>';
    return $content;
  }
  return $content;
}
