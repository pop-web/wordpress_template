...
?>
  ...
  <div class="cb_content">
   ...
   <ul class="option_list">
    ...
    <li class="cf"><span class="label"><?php _e('Font color', 'tcd-w'); ?></span><input type="text" name="dp_options[mobile_contents_builder][<?php echo $cb_index; ?>][message_catch_font_color]" value="<?php echo esc_attr( $value['message_catch_font_color'] ); ?>" data-default-color="#00a6cc" class="c-color-picker"></li>
   </ul>
