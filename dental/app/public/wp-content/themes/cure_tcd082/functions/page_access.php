...
?>
  ...
  <div class="cb_content">
   ...
   <ul class="design_radio_button">
    <li>
     <input type="radio" id="ac_content_width_<?php echo $cb_index; ?>_type1" name="access_content[<?php echo $cb_index; ?>][content_width]" value="type1" <?php checked( $value['content_width'], 'type1' ); ?> />
     <label for="ac_content_width_<?php echo $cb_index; ?>_type1"><span class="page_change_image_width"><?php echo esc_attr($page_content_width); ?></span>px</label>
    </li>
    <li>
     <input type="radio" id="ac_content_width_<?php echo $cb_index; ?>_type2" name="access_content[<?php echo $cb_index; ?>][content_width]" value="type2" <?php checked( $value['content_width'], 'type2' ); ?> />
     <label for="ac_content_width_<?php echo $cb_index; ?>_type2"><?php _e('Full screen width', 'tcd-w');  ?></label>
    </li>
   </ul>
